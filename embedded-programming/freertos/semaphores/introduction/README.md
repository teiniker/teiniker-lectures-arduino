...
(between tasks or between tasks and an interrupt), and **mutexes** the better choice for 
...
want to know if the queue is empty or full. This mechanism can be exploited to 
synchronise (for example) a task with an interrupt.
...
* [YouTube (Digi-Key Electronics): Part 7 - Semaphore](https://youtu.be/5JcMtbA9QEE?si=q3KBLlEQz4lRDHa_)
